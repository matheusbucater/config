;;; rosepineish-theme.el --- Theme

;; Copyright (C) 2024 , coppolimeros
...
;;; Commentary:
;;; rosepineish theme created by coppolimeros in 2024

;;; Code:

;; rosepine palette
(setq ROSE-base     "#191724")
(setq ROSE-surface  "#1f1d2e")
(setq ROSE-overlay  "#26233a")
(setq ROSE-muted    "#6e6a86")
(setq ROSE-subtle   "#908caa")
(setq ROSE-text     "#e0def4")
(setq ROSE-love     "#eb6f92")
(setq ROSE-gold     "#f6c177")
(setq ROSE-rose     "#ebbcba")
(setq ROSE-pine     "#31748f")
(setq ROSE-foam     "#9ccfd8")
(setq ROSE-iris     "#c4a7e7")
(setq ROSE-hl-low   "#21202e")
(setq ROSE-hl-med   "#403d52")
(setq ROSE-hl-high  "#524f67")

;; rosepine moon pallete
(setq ROSEMOON-base    "#232136")
(setq ROSEMOON-surface "#2a273f")
(setq ROSEMOON-overlay "#393552")
(setq ROSEMOON-muted   "#6e6a86")
(setq ROSEMOON-subtle  "#908caa")
(setq ROSEMOON-text    "#e0def4")
(setq ROSEMOON-love    "#eb6f92")
(setq ROSEMOON-gold    "#f6c177")
(setq ROSEMOON-rose    "#ea9a97")
(setq ROSEMOON-pine    "#3e8fb0")
(setq ROSEMOON-foam    "#9ccfd8")
(setq ROSEMOON-iris    "#c4a7e7")
(setq ROSEMOON-hl-low  "#2a283e")
(setq ROSEMOON-hl-med  "#44415a")
(setq ROSEMOON-hl-high "#56526e")

(deftheme rosepineish)
(let ((class '((class color) (min-colors 89)))
      ...
      (type      ROSE-love)
      (var       ROSE-rose)
      (selection ROSE-muted)
      (warning   ROSE-love)
      (warning2  ROSE-gold)
      (org-h1    ROSEMOON-pine)
      (org-h2    ROSEMOON-foam)
      (org-h3    ROSEMOON-rose)
      (org-h4    ROSEMOON-gold)
  ...
  (custom-theme-set-faces
   ...
   `(org-level-1 ((,class (:bold t :foreground , org-h1 :height 1.1))))
   `(org-level-2 ((,class (:bold nil :foreground ,org-h2))))
   `(org-level-3 ((,class (:bold t :foreground ,org-h3))))
   `(org-level-4 ((,class (:bold nil :foreground ,org-h4))))
   `(org-date ((,class (:underline t :foreground ,var) )))
   `(org-footnote  ((,class (:underline t :foreground ,fg4))))
   `(org-link ((,class (:underline t :foreground , ROSE-foam))))
   `(org-special-keyword ((,class (:foreground ,func))))
   `(org-block ((,class (:foreground , ROSE-text))))
...
(provide-theme 'rosepineish)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; rosepineish-theme.el ends here
